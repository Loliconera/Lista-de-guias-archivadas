...
"sub_type": "message",
"delay": 3000,
"message_TW": "Ingrese al área de maquinaria centinela"
...
"message": "Olas"
	...
	if (notice && skillid == 301 ) {
		notice = false;
handlers['text']({"sub_type": "message","message": "¡¡CUIDADO!!","message_TW": "boss扔溜溜球注意躲避"});	
...
// 	召喚点 ，提示（ 提示标志 角度 距离   延迟时间 时间）
   ...
   // "h-935-1000-100": [{"type": "func","func": guid_voice}],
    ...
    "s-935-1000-108-0": [{"type": "text","sub_type": "message","message": "¡SALIR!","message_TW": "出去！" }],
    "s-935-1000-111-0": [{"type": "text","sub_type": "message","message": "Ataque por detras","message_TW": "BOSS 攻击身后打手请注意！" }],	
    "s-935-1000-112-0": [{"type": "text","sub_type": "message","message": "Ataque por detras","message_TW": "BOSS 攻击身后打手请注意！" }],
    "s-935-1000-205-0": [{"type": "text","sub_type": "message","message": "viento","message_TW": "即将开启通风系统，请离开中间！" }],	
    "s-935-1000-304-0": [{"type": "text","sub_type": "message","message": "¡SALIR!","message_TW": "出去！" }],
    "s-935-1000-305-0": [{"type": "text","sub_type": "message","message": "¡ENTRAR!","message_TW": "进！" }],	
    "s-935-1000-306-0": [{"type": "text","sub_type": "message","message": "¡Invocacion de Minas!","message_TW": "召唤地雷！快打！" }], 	
    ...
    "s-935-1000-309-0": [ 
      ...
      {"type": "text","sub_type": "message","delay": 12000,"message": "¡SALTA!", "message_TW": "快跳！"}
],
    "s-935-1000-311-0": [{"type": "text","sub_type": "message","message": "Zona segura -> frente derecha |","message_TW": "安全区域 右前方 →↗" },
     {"type": "func","func": SpawnThing.bind(null,67,120,100,12000)}],//
    "s-935-1000-312-0": [{"type": "text","sub_type": "message","message": "Zona segura -> abajo derecha |","message_TW": "安全区域 右后方 →↘" },
     {"type": "func","func": SpawnThing.bind(null,112,120,100,12000)}],	//
    "s-935-1000-313-0": [{"type": "text","sub_type": "message","message": "| Zona segura -> abajo izquierda","message_TW": "安全区域 后左方 ↓↙" },
     {"type": "func","func": SpawnThing.bind(null,202,120,100,12000)}],//
    "s-935-1000-314-0": [{"type": "text","sub_type": "message","message": "| Zona segura -> frente izquierda","message_TW": "安全区域 前左方 ↑↖" },
     {"type": "func","func": SpawnThing.bind(null,337,120,100,12000)}],//
    "s-935-1000-315-0": [{"type": "text","sub_type": "message","message": "Zona segura -> frente derecha |","message_TW": "安全区域 前右方 ↑↗" },
     {"type": "func","func": SpawnThing.bind(null,22,120,100,12000)}],	//
    "s-935-1000-316-0": [{"type": "text","sub_type": "message","message": "Zona segura -> abajo derecha |","message_TW": "安全区域 后右方 ↓↘" },
     {"type": "func","func": SpawnThing.bind(null,157,120,100,12000)}],//
    "s-935-1000-317-0": [{"type": "text","sub_type": "message","message": "| Zona segura -> abajo izquierda","message_TW": "安全区域 左后方 ←↙" },
     {"type": "func","func": SpawnThing.bind(null,247,120,100,12000)}],//
    "s-935-1000-318-0": [{"type": "text","sub_type": "message","message": "| Zona segura -> frente izquierda","message_TW": "安全区域 左前方 ←↖" },
     {"type": "func","func": SpawnThing.bind(null,292,120,100,12000)}],//
    "s-935-1000-319-0": [{"type": "text","sub_type": "message","message": "Zona segura -> frente derecha |","message_TW": "安全区域 前右方 ↑↗" },
     {"type": "func","func": SpawnThing.bind(null,22,120,100,12000)}],	//
    "s-935-1000-320-0": [{"type": "text","sub_type": "message","message": "Zona segura -> abajo derecha |","message_TW": "安全区域 后右方 ↓↘" },
     {"type": "func","func": SpawnThing.bind(null,157,120,100,12000)}],//
    "s-935-1000-321-0": [{"type": "text","sub_type": "message","message": "| Zona segura -> abajo izquierda","message_TW": "安全区域 后左方 ↓↙" },
     {"type": "func","func": SpawnThing.bind(null,202,120,100,12000)}],//
    "s-935-1000-322-0": [{"type": "text","sub_type": "message","message": "| Zona segura -> frente izquierda","message_TW": "安全区域 左前方 ←↖" },
     {"type": "func","func": SpawnThing.bind(null,292,120,100,12000)}],	//
    "s-935-1000-323-0": [{"type": "text","sub_type": "message","message": "Zona segura -> frente derecha |","message_TW": "安全区域 右前方 →↗" },
     {"type": "func","func": SpawnThing.bind(null,67,120,100,12000)}], //
    "s-935-1000-324-0": [{"type": "text","sub_type": "message","message": "Zona segura -> abajo derecha |","message_TW": "安全区域 右后方 →↘" },
     {"type": "func","func": SpawnThing.bind(null,112,120,100,12000)}],//
    "s-935-1000-325-0": [{"type": "text","sub_type": "message","message": "| Zona segura -> abajo izquierda","message_TW": "安全区域 左后方 ←↙" },
     {"type": "func","func": SpawnThing.bind(null,247,120,100,12000)}],//
    "s-935-1000-326-0": [{"type": "text","sub_type": "message","message": "| Zona segura -> frente izquierda","message_TW": "安全区域 前左方 ↑↖" },
     {"type": "func","func": SpawnThing.bind(null,337,120,100,12000)}],//

//------------------------------------2王

"s-935-2000-102-0": [{"type": "text","class_position":"tank","sub_type": "message","message": "Ataque frontal","message_TW": "前砸注意躲避"}],
"s-935-2000-105-0": [{"type": "text","sub_type": "message","message": "Giro (inclinación)","message_TW": "注意击飞"},
{"type": "func","func": Spawnitem2.bind(null,912,0,0,15,250,100,4000)}
],
"s-935-2000-108-0": [{"type": "text","sub_type": "message","message": "Ataque por detras (iframe)","message_TW": "后踢打手補师注意"}],
"s-935-2000-301-0": [{"type": "func","func": skilld_event.bind(null, 301)}],

"s-935-2000-304-0": [{"type": "text","sub_type": "message","message": "¡¡SALIR!!","message_TW": "快跑远"}],
"s-935-2000-305-0": [{"type": "text","sub_type": "message","message": "¡¡ENTRAR!!","message_TW": "快靠近"},
{"type": "func","func": Spawnitem2.bind(null,912,0,0,15,225,100,4000)}
],
"s-935-2000-308-0": [{"type": "text","sub_type": "message","message": "| Izquierda","message_TW": "左←"}],
"s-935-2000-309-0": [{"type": "text","sub_type": "message","message": "Derecha |","message_TW": "右→"}],
...
//s拳
"s-935-3000-116-0": [{"type": "text","sub_type": "message","message": "DERECHA |","message_TW": "S拳秒杀躲避右边 →↘"}, 
...
"s-935-3000-117-0": [{"type": "text","sub_type": "message","message": "| IZQUIERDA","message_TW": "S拳秒杀躲避 左边 ←↙"}, 
...
"s-935-3000-118-0": [{"type": "text","sub_type": "message","message": "| IZQUIERDA","message_TW": "S拳秒杀躲避 左边 ←↙"}, 
	{"type": "func","func": Spawnitem.bind(null,6,10,200,0,3000)},
	{"type": "func","func": Spawnitem.bind(null,6,190,200,0,3000)},	
	{"type": "func","func": Spawnitem1.bind(null,912,10,210,0,290,3000)},
	{"type": "func","func": Spawnitem.bind(null,912,20,210,0,3000)},		
	...
	{"type": "func","func": Spawnitem.bind(null,912,200,210,0,3000)},	
	{"type": "func","func": Spawnitem1.bind(null,912,190,210,180,290,3000)}],	
"s-935-3000-119-0": [{"type": "text","sub_type": "message","message": "DERECHA |","message_TW": "S拳秒杀躲避右边 →↘"}, 
	{"type": "func","func": Spawnitem.bind(null,6,170,200,0,3000)},
	{"type": "func","func": Spawnitem.bind(null,6,350,200,0,3000)},	
	{"type": "func","func": Spawnitem.bind(null,912,120,250,0,3000)},
	{"type": "func","func": Spawnitem.bind(null,912,130,240,0,3000)},	
...
"s-935-3000-129-0": [{"type": "text","class_position":"tank","sub_type": "message","message": "iframe","message_TW": "坦无敌闪"}],	
...
"s-935-3000-305-0": [{"type": "func","func": Spawnitem2.bind(null,912,0,0,15,300,100,7000)}],
  "s-935-3000-321-0": [
          ...
          {"type": "text","sub_type": "message","delay": 105000,"message": "¡BOSS Activara ESCUDO en 10s! ", "message_TW": "10S后准备破盾！"}	  
		 ],

"s-935-3000-324-0": [{"type": "text","sub_type": "message","message": "¡Stun!","message_TW": "出去"}]

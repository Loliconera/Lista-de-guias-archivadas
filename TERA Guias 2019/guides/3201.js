...
module.exports = {
	...
	"s-3201-1000-104-0": [{"type": "text","class_position":"tank","sub_type": "message","message": "Ataque de Stun","message_RU": "Стан!!!"}],
	"s-3201-1000-107-0": [{"type": "text","sub_type": "message","message": "Ataque por detras","message_RU": "|Полоса|" },
						  {"type": "text","sub_type": "message","delay": 2250,"message": "pull","message_RU": "Откид!!!"}
	],

	"s-3201-1000-111-0": [{"type": "text","sub_type": "message","message": "Atención DPS a distancia","message_RU": "Волна назад"}],
	//"s-3201-1000-112-0": [{"type": "text","sub_type": "message","message": "Left + Right","message_RU": "Лево + Право" }],
	"s-3201-1000-113-0": [{"type": "text","sub_type": "message","message": "Salto (lento)","message_RU": "Прыжок" },
	...
	"s-3201-1000-118-0": [{"type": "text","sub_type": "message","message": "Salto P (lento)","message_RU": "Прыжок" },
						  {"type": "text","sub_type": "message","delay": 1500,"message": "pull","message_RU": "Камень!"},
	],
	//{"type": "text","sub_type": "notification","delay": 1500,"message": "pull","message_RU": "Камень!"}	
	"s-3201-1000-119-0": [{"type": "text","sub_type": "message","delay": 1000,"message": "Ataque detras + Frontal","message_RU": "Вперед + Назад" }],
	...
	"s-3201-1000-124-0": [{"type": "text","class_position":"tank","sub_type": "message","message": "Ataque de Stun (rápido)","message_RU": "Стан (фаст)"}],
	"s-3201-1000-127-0": [{"type": "text","class_position":"dps","sub_type": "message","message": "Ataque por detras (rápido)","message_RU": "|Полоса| (фаст)"},
						  {"type": "text","class_position":"heal","sub_type": "message","message": "Ataque por detras (rápido)","message_RU": "|Полоса| (фаст)"}
	],
	//"s-3201-1000-128-0": [{"type": "text","class_position":"tank","sub_type": "message","message": "Triple Attack","message_RU": "Комба"}],
	"s-3201-1000-131-0": [{"type": "text","class_position":"dps","sub_type": "message","message": "Atención DPS a distancia (rápido)","message_RU": "Волна назад (фаст)"},
						  {"type": "text","class_position":"heal","sub_type": "message","message": "Atención DPS a distancia (rápido)","message_RU": "Волна назад (фаст)"}
	],
	//"s-3201-1000-132-0": [{"type": "text","sub_type": "message","message": "Left + Right","message_RU": "Лево + Право (фаст)"}],
	"s-3201-1000-133-0": [{"type": "text","sub_type": "message","delay": 500,"message": "Salto (rápido)","message_RU": "Прыжок (фаст)"}],
	"s-3201-1000-138-0": [{"type": "text","sub_type": "message","delay": 500,"message": "Salto P (rápido)","message_RU": "Прыжок (фаст)"}],
	"s-3201-1000-139-0": [{"type": "text","sub_type": "message","message": "Ataque detras + Frontal (rápido)","message_RU": "Вперед + Назад (фаст)"}],
	...
	"s-3201-1000-143-0": [{"type": "text","class_position":"tank","sub_type": "message","message": "Izquierda > Derecha","message_RU": "Слева > Справа"},
						  {"type": "text","class_position":"dps","sub_type": "message","message": "Derecha < Izquierda","message_RU": "Справа < Слева"},
						  {"type": "text","class_position":"heal","sub_type": "message","message": "Derecha < Izquierda","message_RU": "Справа < Слева"},
	...
	"s-3201-1000-145-0": [{"type": "text","class_position":"tank","sub_type": "message","message": "Izquierda > Derecha","message_RU": "Слева > Справа"},
						  {"type": "text","class_position":"dps","sub_type": "message","message": "Derecha < Izquierda","message_RU": "Справа < Слева"},
						  {"type": "text","class_position":"heal","sub_type": "message","message": "Derecha < Izquierdat","message_RU": "Справа < Слева"},
						  {"type": "func","func": SpawnMarker.bind(null,false,30,300,100,1000,true,null)},	//1
						  {"type": "func","func": SpawnMarker.bind(null,false,330,300,1100,5000,true,null)}, //7
	...
	"s-3201-1000-148-0": [{"type": "text","sub_type": "message","message": "Mano Derecha (volando)","message_RU": "Правая рука (подлет)"}],
	"s-3201-1000-149-0": [{"type": "text","sub_type": "message","message": "Mano Izquierda (volando)","message_RU": "Левая рука (подлет)"}],
	"s-3201-1000-151-0": [{"type": "text","sub_type": "message","message": "Ataque de Stun","message_RU": "Стан!!!"}],
	...
	"s-3201-1000-313-0": [{"type": "text","sub_type": "message","message": "Círculos (lento)","message_RU": "Кольцо"},{"type": "func","func": SpawnCircle.bind(null,false,553,0,75,10,300,0,6000)}],
	"s-3201-1000-314-0": [{"type": "text","sub_type": "message","message": "Círculos (rápidos)","message_RU": "Кольцо (фаст)"},{"type": "func","func": SpawnCircle.bind(null,false,553,0,75,10,300,0,6000)}],
	...
	"s-3201-2000-108-0": [{"type": "text","sub_type": "message","message": "Ataque por detras!","message_RU": "Откид назад!"}],
	...
	"am-3201-320126-32010224": [{"type": "text","sub_type": "notification","message": "Siguiente Verdadero","message_RU": "След. правда"},{"type": "func","func": skilld_event.bind(null, 32010224)}],
	"am-3201-2000-32010220": [{"type": "text","sub_type": "notification","message": "Siguiente Falso","message_RU": "След. ложь"},{"type": "func","func": skilld_event.bind(null, 32010220)}],
	...
	"s-3201-2000-228-0": [ 
		...
		{"type": "text","sub_type": "message","delay": 3500,"message": "Iframe","message_RU": "Эвейд"}
	...
	"s-3201-2000-231-0": [{"type": "text","sub_type": "message","message": "SALIR seguro","message_RU": "ОТ НЕГО"},
						  {"type": "func","func": SpawnCircle.bind(null,false,553,0,0,10,300,0,3000)}
	],
	"s-3201-2000-232-0": [{"type": "text","sub_type": "message","message": "ENTRAR seguro","message_RU": "К НЕМУ"},
						  {"type": "func","func": SpawnCircle.bind(null,false,553,0,0,10,300,0,3000)},

...
function SpawnThingobject( degrees, radius, delay, times, handlers, event, entity ) {
   ...
   let angle =  Math.PI * degrees / 180 
        handlers['spawn']({
        	...
        	"offset": angle,
			"ownerName": "巴哈勒",
			"message": "Wang sentado dirección"
        }, {loc: shield_loc});  
}
...
module.exports = {
 ...
 "s-750-1001-1102-0": [{"type": "text","sub_type": "message","message":  'Ataque giratorio',"message_TW": "旋转攻击" }], 
 "s-750-1001-1103-0": [{"type": "text","sub_type": "MSG","message":  'floor',"message_TW": "1103巨型虫植物地板触水攻击heavyatk 01老马" }], 
 "s-750-1001-1104-0": [{"type": "text","sub_type": "MSG","message":  '_',"message_TW": "1104巨型虫植物根传唤攻击longAtk 01老话" }], 
 "s-750-1001-1105-0": [{"type": "text","sub_type": "message","message":  'SALIR',"message_TW": "远离" },
 ...
 "s-750-1001-1109-0": [{"type": "text","sub_type": "message","message":  'SALIR',"message_TW": "準備遠離" }], 
 "s-750-1001-1110-0": [{"type": "text","sub_type": "message","message":  'knock down',"message_TW": "擊倒" }], 
 ...
 "s-750-1001-2102-0": [{"type": "text","sub_type": "message","message":  'Ataque giratorio',"message_TW": "旋转攻击" }], 
 "s-750-1001-2103-0": [{"type": "text","sub_type": "MSG","message":  'floor',"message_TW": "2103巨型虫植物地板触水攻击heavyatk 01愤怒" }], 
 "s-750-1001-2104-0": [{"type": "text","sub_type": "MSG","message":  '_',"message_TW": "2104巨型虫植物根传唤攻击longAtk 01愤怒" }], 
 "s-750-1001-2105-0": [{"type": "text","sub_type": "message","message":  'SALIR',"message_TW": "远离" },
	                    {"type": "func","func": Spawnitem2.bind(null,445,0,0,8,375,100,4000)}], 
 ...
 "s-750-1001-2109-0": [{"type": "text","sub_type": "message","message":  'SALIR',"message_TW": "準備遠離" }], 
 "s-750-1001-2110-0": [{"type": "text","sub_type": "message","message":  'knock down',"message_TW": "擊倒" }], 


//-----------------------------------------------------------------------------------------------------2
 "s-750-45016-1308-0": [{"type": "text","sub_type": "message","message":  'Círculos de veneno',"message_TW": "圈" },
	                    {"type": "func","func": Spawnitem2.bind(null,445,0,0,8,375,100,6000)}], 

"s-750-1002-1101-0": [{"type": "text","sub_type": "MSG","message":  'Derecha',"message_TW": "巨大马蜂右手攻击atk 01老话" }],
"s-750-1002-1102-0": [{"type": "text","sub_type": "MSG","message":  'Izquierda',"message_TW": "巨型马蜂左手拍攻击atk 02老话" }],
"s-750-1002-1103-0": [{"type": "text","sub_type": "MSG","message":  '_',"message_TW": "用巨型马蜂前脚进行蜂箱旋转攻击heavyAtkcomboatk 01" }],
"s-750-1002-1105-0": [{"type": "text","sub_type": "MSG","message":  'double handed',"message_TW": "用巨型马蜂的前锋攻击heavyAtk 03老末" }],
"s-750-1002-1106-0": [{"type": "text","sub_type": "MSG","message":  'stun',"message_TW": "巨型马蜂空中飞来发射毒针的longAtk老马" }],
"s-750-1002-1107-0": [{"type": "text","sub_type": "message","message":  'Ataque volador',"message_TW": "飞天攻击" }],
...
"s-750-1002-1202-0": [{"type": "text","sub_type": "MSG","message":  'knock down',"message_TW": "巨马蜂巢longMove nove" }],
...
"s-750-1002-2101-0": [{"type": "text","sub_type": "MSG","message":  'Derecha',"message_TW": "巨大马蜂右手攻击atk 01愤怒" }],
"s-750-1002-2102-0": [{"type": "text","sub_type": "MSG","message":  'Izquierda',"message_TW": "巨大马蜂左手拍攻击atk 02愤怒" }],
"s-750-1002-2103-0": [{"type": "text","sub_type": "MSG","message":  '_',"message_TW": "用巨型马蜂前脚进行蜂箱旋转攻击heavyAtkcomboatk 01" }],
"s-750-1002-2105-0": [{"type": "text","sub_type": "MSG","message":  'double handed',"message_TW": "用巨型马蜂的前锋攻击heavyAtk 03愤怒" }],
"s-750-1002-2106-0": [{"type": "text","sub_type": "MSG","message":  'stun',"message_TW": "巨型马蜂空中飞来发射毒针的longAtk愤怒" }],
"s-750-1002-2107-0": [{"type": "text","sub_type": "message","message":  'Ataque volador',"message_TW": "飞天攻击" }],
...
"s-750-1002-2202-0": [{"type": "text","sub_type": "MSG","message":  'knock down',"message_TW": "巨大的马蜂longMove愤怒" }],
...
"s-750-1002-2302-0": [{"type": "text","sub_type": "MSG","message":  '_',"message_TW": "巨大的马蜂不可保障的50%" }],					
 "s-750-1002-1108-0": [{"type": "text","sub_type": "message","message":  'overpower',"message_TW": "壓人" }], 
 "s-750-1002-2108-0": [{"type": "text","sub_type": "message","message":  'overpower',"message_TW": "壓人" }], 
 "s-750-1002-2104-0": [{"type": "text","sub_type": "message","message":  'pull',"message_TW": "拉人" },
                      {"type": "text","sub_type": "message","delay": 3000,"message":  'iframe',"message_TW": "閃避" }],  
 "s-750-1002-1104-0": [{"type": "text","sub_type": "message","message":  'pull',"message_TW": "拉人" },
                      {"type": "text","sub_type": "message","delay": 3000,"message":  'iframe',"message_TW": "閃避" }],
...
"s-750-1003-1306-0": [{"type": "text","sub_type": "message","message":  'SALIR',"message_TW": "远离" }],
...
"s-750-1003-1309-0": [{"type": "text","sub_type": "message","message":  'Escudo',"message_TW": "破盾" }],
...
"s-750-1003-2301-0": [{"type": "text","sub_type": "message","message":  'Pilar de cristal',"message_TW": "打水晶柱" }],
...
"s-750-1003-2306-0": [{"type": "text","sub_type": "message","message":  'SALIR',"message_TW": "远离" }],
